    ...
    items: [
      {
        ...
        link: `https://github.com/${config.author}/${config.siteName}`,
      },
      { label: 'about.source.gitee', link: `https://gitee.com/${config.org}/${config.siteName}` },
      { label: 'about.source.npm', link: `https://www.npmjs.com/package/${config.siteName}` },
      {
